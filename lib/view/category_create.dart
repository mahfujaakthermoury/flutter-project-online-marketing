...
class _CategoryEditState extends State<CategoryAdd> {
  ...
  Future addrequest() async {
    ...
    var postUri = Uri.parse(Helper.baseurl+"savecategory");
              ...
              GestureDetector(
                child: Container(
                  child:    _image != null ? Container(
                      ...
                      child: Image.file(_image))  : Icon(Icons.add_a_photo_outlined,size: 48,),
                ),
